...
output_folder = '/thesis/data_analysis/correlation'
        ...
        if date_IMERG == date_DWD:
            ...
            for i in range(len(values_IMERG)):
                for j in range(len(values_IMERG[i])):
                    ...
                    value_mask = mask_array[i][j]
                    
                    if value_IMERG != -9999000 and value_DWD != -9999000 and value_mask != 0:
...
for month in results:
    ...
    print('Correlation between daily OPERA and DWD estimates for month #'+str(month),'is', r[0][1])
...
print('Correlation between daily OPERA and DWD estimates for the year 2015 is ', r[0][1])
