...
def calculate_residuals(dwd_filenames, opera_filenames, output_folder, mask=None):
        ...
        for _, filenames in matching_pairs.items():
            ...
            for i in range(len(ref_array)):
                for j in range(len(ref_array[i])):
                    ...
                    if ref_value != -9999000 and opera_value != -9999000:
...
far,  rmse, rel_bias, cor = get_summary(REF_PATH, MERGED_PATH, RES_OUTPUT_PATH)
...
OPERA_PATH = os.path.join('/data/thesis/data_analysis/opera/3tiff_p_d', YEAR)
REF_PATH = os.path.join('/data/thesis/data_analysis/dwd/7alignOPERA', YEAR)
RES_PATH = os.path.join('/data/thesis/data_analysis/residuals/1res_OPERA', YEAR)

calculate_residuals(REF_PATH, OPERA_PATH, RES_PATH, None)

far, pod, rmse, rel_bias, cor = get_summary(REF_PATH, OPERA_PATH, RES_PATH, None)
